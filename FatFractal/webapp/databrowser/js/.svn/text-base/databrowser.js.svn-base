...
var ffdb_mainViewModel = {
    ...
    allowNewCollections : new ko.observable(false),
    ...
    setAppUrl: function(formElement) {
        ...
        if (baseUrl != appUrl) {
            ...
            ffdb_mainViewModel.allowNewCollections(false); ffdb_mainViewModel.tableVisible(false); ffdb_mainViewModel.detailVisible(false);
